...
var (
	Village = Map{
		Name:        "Village",
		PlayerStart: model.Coord{X: 2, Y: 4, Map: 0},
		MapMatrix: [][]int{
		...
		MapTransitions: []SpecialTile{
			{"MapTransition", model.Coord{X: 0, Y: 0, Map: 0}, model.Coord{X: 5, Y: 0, Map: 1}},
		},
	}
	ToTheOldMine = Map{
		...
		MapTransitions: []SpecialTile{
			{"MapTransition", model.Coord{X: 0, Y: 0, Map: 1}, model.Coord{X: 2, Y: 4, Map: 0}},
		},
	}
